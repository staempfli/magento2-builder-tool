...
if (!function_exists('spyc_load')) {
  ...
  function spyc_load ($string) {
    return SpycLib::YAMLLoadString($string);
  }
}
...
if (!function_exists('spyc_dump')) {
  ...
  function spyc_dump ($data) {
    return SpycLib::YAMLDump($data, false, false, true);
  }
}
...
/**
   ...
   * <code>
   *   $SpycLib  = new SpycLib;
   *   $array = $SpycLib->load($file);
   * </code>
   * or:
   * <code>
   *   $array = SpycLib::YAMLLoad($file);
   * </code>
   * or:
   * <code>
...
/**
 * Load a valid YAML string to SpycLib.
 * @param string $input
 * @return array
 */
 ...
 /**
 * Load a valid YAML file to SpycLib.
 * @param string $file
 * @return array
 */
  ...
  /**
     ...
     *  Usage:
     *  <code>
     *   $array = SpycLib::YAMLLoad('lucky.yaml');
     *   print_r($array);
     *  </code>
     * @access public
     * @return array
...
// Enable use of SpycLib from command line
// The syntax is the following: php SpycLib.php spyc.yaml

do {
  if (PHP_SAPI != 'cli') break;
  if (empty ($_SERVER['argc']) || $_SERVER['argc'] < 2) break;
  if (empty ($_SERVER['PHP_SELF']) || FALSE === strpos ($_SERVER['PHP_SELF'], 'SpycLib.php') ) break;
  $file = $argv[1];
